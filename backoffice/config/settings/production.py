...
# STATIC
# ------------------------
STATICFILES_STORAGE = "backoffice.utils.storages.StaticS3Storage"
COLLECTFAST_STRATEGY = "collectfast.strategies.boto3.Boto3Strategy"
STATIC_URL = f"https://{aws_s3_domain}/static/"
# MEDIA
# ------------------------------------------------------------------------------
DEFAULT_FILE_STORAGE = "backoffice.utils.storages.MediaS3Storage"
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="backoffice <noreply@example.com>",
)
